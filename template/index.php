...
<?php
   ...
   foreach ($sceneAssocFileSystemSet as $key => $value) {
      ...
      // el inicio de la declaraci�n de los archivos
      ...
      foreach ($value as $browsableEntryId) {
         ...
         // Se solicita la URL que corresponda seg�n la acci�n deseada,
         // mostrar o publicar la selecci�n
         $currentUrl = "";
         if ($SaveContainer) {
      ...
      // Se cierra la declaraci�n de la unidad
      printf ("]} );\r\n");
   }
